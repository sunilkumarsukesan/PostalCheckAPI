...
@RetrieveInformation 
Scenario: Test to verify whether the user can retrive information using postal/zip code 
...
@ApartFromUSAandGB 
Scenario: Test to verify whether the user is allowed to get information about postal/zip code other than USA and GB 
	Given As a user i have valid Base URL 
...
Scenario: Test to verify whether the user is allowed to get information about postal/zip code after entering an incorrect postal/zip code 
	Given As a user i have valid Base URL 
	And I set the country as "United States" 
	And I retrieve the country code from the CSV file 
	When I send the postal code "210" along with country code 
